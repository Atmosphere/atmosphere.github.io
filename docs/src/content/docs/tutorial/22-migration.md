...
3. **Update** `atmosphere-runtime` dependency to the current `4.0.x` release (at time of writing, `4.0.36-SNAPSHOT` on `main`; check Maven Central for the latest stable)
