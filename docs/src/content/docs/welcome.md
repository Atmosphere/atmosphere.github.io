...
This documentation covers the **Atmosphere 4.0.x** release line with JDK 21+, Spring Boot 4.0.6, and Quarkus 3.36.0. See [What's New](/docs/whats-new/) for a highlights reel of changes since the 4.0.0 release.
